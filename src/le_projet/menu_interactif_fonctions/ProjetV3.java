 ...
 */
package le_projet.menu_interactif_fonctions;

/**
 * /*
 * #	Apprentissage de Java Dini Ahamada #	De l'algorithme paramétré à l'écriture
 * de fonction #	Section : Projet #	Fichier : ProjetCh5.java #	Class : ProjetCh5
 */
import java.util.*;

public class ProjetV3 {
